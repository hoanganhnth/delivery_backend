...
@Entity
@Table(name = "promotion_outbox_events", indexes = {
        @Index(name = "idx_promotion_outbox_pending",
                columnList = "status,next_attempt_at,created_at,event_id"),
        @Index(name = "idx_promotion_outbox_aggregate",
