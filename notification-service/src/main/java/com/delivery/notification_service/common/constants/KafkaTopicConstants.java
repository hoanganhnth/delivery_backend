...
public class KafkaTopicConstants {
    ...
    public static final String MATCH_FOUND_TOPIC = "match.shipper-matched";  // ✅ Legacy topic
    public static final String SHIPPER_FOUND_TOPIC = "shipper.found";       // ✅ New unified event
