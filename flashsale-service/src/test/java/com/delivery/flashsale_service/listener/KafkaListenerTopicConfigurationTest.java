...
class KafkaListenerTopicConfigurationTest {
    ...
    @Test
    void flashSaleReservationListenerUsesOwnerIsolatedRecoveryTopics() throws Exception {
        ...
        assertThat(retry.retryTopicSuffix()).isEqualTo("-retry-flashsale");
        assertThat(retry.dltTopicSuffix()).isEqualTo(".flashsale.DLT");
