...
> Backend-owned service documentation lives here. Cross-system architecture,
> client behavior, public handbook inputs and reconciliation authority live in
> [`docs/platform/`](platform/README.md). Do not create a second platform-level
> truth in this service-local index.
...
- [Editable Mermaid architecture](platform/ARCHITECTURE.md): polyrepo context,
