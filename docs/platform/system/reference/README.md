...
This generated mirror preserves 535 first-party documentation, runtime configuration, migration, deployment, monitoring and client-manifest files under workspace/ using their original workspace paths. Relative links among copied documentation therefore continue to resolve wherever their targets are also mirrored.
